...
// Все равно при указании ключей "1", "2", "3" ... консоль FF выдает 1 empty slot. Chromium молчит. Замена ключей на двузначные цифры "11", "22" ... или на нумерацию с "0", "1", ... решает проблему. В чем дело - непонятно.
...
// Создавать динамически из загруженных данных на основе indicators_map.
...
// Для примера - словарь кодов колонок таблицы
var new_columns_map = { "title": "Название",
         1101: "Денежные средства",
        1102: "Драгметаллы и камни",
        1103: "Средства в НБРБ",
        1105: "Ценные бумаги",
        1106: "Кредиты клиентам",
        1201: "Средства НБРБ",
        1202: "Средства банков",
        1203: "Средства клиентов",
        1204: "Ценные бумаги банка",
        1211: "Уставный фонд",
        1213: "Резервный фонд",
        1215: "Накопленная прибыль"
};
...
// Зачем data_main? - Для того, чтобы сохранить данные в странице. Иначе по
	// клику на селектор нельзя будет вызвать redraw(data, state_map).
...
// state_map можно не указывать, это глобальная переменная
